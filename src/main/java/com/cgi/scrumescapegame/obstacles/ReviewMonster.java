...
public class ReviewMonster implements Obstacle {
    ...
    public ReviewMonster() {
        puzzle = new Puzzle();
        puzzle.addQuestion(new Matching(Arrays.asList("Agile", "Scrum", "Sprint", "Product Owner"), Arrays.asList("Een iteratie van 1-4 weken", "Een framework voor Agile ontwikkeling", "Een rol binnen Scrum", "Een mindset"), Arrays.asList("1A", "2B", "3C", "4D")));
