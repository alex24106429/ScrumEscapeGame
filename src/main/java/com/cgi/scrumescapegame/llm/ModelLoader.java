...
public final class ModelLoader {
    ...
    // New overloaded method to load from InputStream
    public static Llama loadModel(InputStream inputStream, int contextLength, boolean loadWeights) throws IOException {
        Path tempFile = null;
        try {
            tempFile = Files.createTempFile("gguf-model-", ".gguf");
            Files.copy(inputStream, tempFile, StandardCopyOption.REPLACE_EXISTING);
            return loadModel(tempFile, contextLength, loadWeights); // Call the existing method
        } finally {
            if (tempFile != null) {
